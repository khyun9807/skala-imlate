...
export const YESTERDAY_TEMPLATES: readonly string[] = [
  '어제 교육생 {n}분이 사감님의 호날두 수면법을 도왔습니다.',
  '어제 교육생 {n}분이 강의실에 한동안 묶여 있었습니다. 자발적으로요.',
  '어제 교육생 {n}분이 강의실과 조금 긴 시간을 함께했습니다.',
  '어제 교육생 {n}분이 강의실과 긴 시간을 보낸 뒤 23시 30분에 작별했습니다.',
  '어제 교육생 {n}분이 강의실과 자정 직전까지 동행했습니다.',
  '어제 교육생 {n}분이 강의실과 조금 긴 하루를 보내고 23시 30분에 헤어졌습니다.',
]
